...
disply_width = _root.winfo_screenwidth()
disply_height = _root.winfo_screenheight()
...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window", icon="default",
                 width=200, height=200, autoflush=True):
        assert type(title) == type(""), "Title must be a string"
        assert type(icon) == type(""), "Icon must be a valid bitmap"
